      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I have a deep passion for the IT environment, and I've certainly learned a lot along the way, or so I believe... 🤷‍♂️
              <br />
              <br />My experience encompasses classics such as
              <i>
